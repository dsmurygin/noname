...
<?php
    ...
    if (strlen($post->book_description)>300){
        $description = mb_substr($post->book_description, 0, 300, 'UTF-8') . ' . . .';
    }
    else {
        $description =$post->book_description;
    }
?>
<div class="post_box post_box_border" id = "<?= $post->book_id ?>">
